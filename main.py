...
def create_app(rate_limit_value: StrOrCallable = RATE_LIMIT_VALUE) -> FastAPI:
    ...
    inventory_router = create_inventory_router(
        rate_limiter, items_contents, inventories_contents
    )
...
def create_items_inventories() -> Tuple[Dict, Dict]:
    items_contents: Dict[str, Dict[str, Any]] = {
        ...
        "item3": {"name": "Item 3", "price": 30.99, "description": "Description 3"},
        "item4": {"name": "Item 4", "price": 40.99, "description": "Description 4"},
    }
