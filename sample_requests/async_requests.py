...
async def sample_async_get_request(
    base_url: str, endpoint_prefix: str, item_id: str
) -> Tuple[int, dict]:
...
async def sample_async_post_request(
    base_url: str, endpoint: str, sample_data: dict
) -> Tuple[int, dict]:
...
if __name__ == "__main__":
    ...
    pprint(
        asyncio.run(sample_async_post_request(base_url, endpoint_prefix, sample_data))
    )
    pprint(
        asyncio.run(sample_async_post_request(base_url, endpoint_prefix, sample_data))
    )
